...
[![status](https://nodei.co/npm/xk-toolbox.png?downloads=true&downloadRank=true&stars=true)](https://nodei.co/npm/xk-toolbox)

---
![release](https://img.shields.io/github/release-date/XK-Z0-XD/xk-toolbox?logo=git)
# xk-toolbox
This is a collection of js modules and css styles.
...
| Builds/Workflows | ![codeql](https://github.com/XK-Z0-XD/xk-toolbox/actions/workflows/codeql.yml/badge.svg) <br/> ![Build & Test](https://github.com/XK-Z0-XD/xk-toolbox/actions/workflows/test.yml/badge.svg) |
...
| technologies |  [![Node.js](https://custom-icon-badges.demolab.com/badge/-Node.js-339933?style=for-the-badge&logo=node.js&logoColor=white)](https://nodejs.org/) <br/> ![vs](https://custom-icon-badges.demolab.com/badge/Visual-Studio?logo=visualstudio&label&message=VisualStudio&logoColor=purple) ![vs](https://custom-icon-badges.demolab.com/badge/Visual-Studio-Code?logo=visualstudiocode&label&message=Visual_Studio_Code&logoColor=blue) ![github](https://custom-icon-badges.demolab.com/badge/Git-Hub?logo=github&label=Github&message=Github) ![git](https://custom-icon-badges.demolab.com/static/v1?logo=git&label&message=git&color=red&logoColor=white)  |

![2](https://custom-icon-badges.demolab.com/static/v1?logo=javascript&label&message=javascript) ![2](https://custom-icon-badges.demolab.com/static/v1?logo=html&label&message=html) ![3](https://custom-icon-badges.demolab.com/static/v1?logo=dotnet&label&message=.NET) ![2](https://custom-icon-badges.demolab.com/static/v1?logo=typescript&label&message=javascript)
![2](https://custom-icon-badges.demolab.com/static/v1?logo=css3&label&message=CSS3)![2](https://custom-icon-badges.demolab.com/static/v1?logo=diagramsdotnet&label&message=Diagrams.net&logoColor=white&color=orange)
![2](https://custom-icon-badges.demolab.com/static/v1?logo=md&label&message=Markdown&logoColor=white&color=orange)
#   Links
...
It contains:
 - Nodejs Modules/ Js Modules
 - CSS Stylesheets
 - json config files
-  font files
-  other
## What does it do?
Well, it does not do anything aside for being a library for js/ nodejs and css styles.
The purpose of this package is so that I can store any modules/ styles that I might use later.
This one should be more organized than my other packages.

## How do I use it?
Since I am using this package to store my styles and themes along with the modules, I would not recommend installing this package into your projects. But if you wanted to, then you can do one of the following:
- Installing into your nodejs project:
  - I use visual studio to install packages on my projects, you can learn how to that through the link [`here`](https://learn.microsoft.com/en-us/visualstudio/javascript/npm-package-management?view=vs-2022)
  - To learn how to install them locally, you can checkout this link here (Make sure you have the latest version of NodeJs installed on your operating system.) :arrow_right: [NPM Documentation](https://docs.npmjs.com/downloading-and-installing-packages-locally)

If you want to access the stylesheets, you can use the copy & paste the link below (just replace the `<version>` with the latest version of the npm package and the `<theme>`[^1] with an existing theme from the package)
  ``` 
